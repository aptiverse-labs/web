          ...
          <Stack spacing={1}>
            {completed.map((t) => (
              <Stack
                ...
                alignItems="center"
                spacing={1.5}
                sx={{ p: 1.25, borderRadius: 1.5, bgcolor: "success.main", color: "success.contrastText", opacity: 0.95 }}
              >
            ...
            {completed.length === 0 && (
              <Typography variant="body2" color="text.secondary">
                Nothing mastered yet — every expert started where you are now.
              </Typography>
            )}
          </Stack>
        </CardContent>
          ...
          <Stack spacing={1}>
            {upcoming.map((t) => (
              <Stack
                ...
                alignItems="center"
                spacing={1.5}
                sx={{ p: 1.25, borderRadius: 1.5, border: 1, borderColor: "divider", borderStyle: "dashed" }}
              >
            ...
            {upcoming.length === 0 && (
              <Typography variant="body2" color="text.secondary">
                Nothing left untouched — you've started on every topic.
              </Typography>
            )}
          </Stack>
        </CardContent>
