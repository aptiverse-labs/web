...
import { usePastPapers, type PastPaper } from "@/lib/api/queries";

export default function PastPapersPage() {
  const query = usePastPapers();
    ...
    <>
      ...
      <QueryStates
        ...
        empty={{
          ...
          description: "We're still curating papers. Check back soon, or generate practice questions from your weakest topics.",
          action: (
            <Button variant="contained" href="/dashboard/practice">
              Go to practice
            </Button>
          ),
        }}
      >
        {(papers) => <PastPapersList papers={papers} />}
      </QueryStates>
    </>
  );
}

function PastPapersList({ papers }: { papers: PastPaper[] }) {
